...
export default class GroupScreen extends Component {
  ...
  onSelectedItemsChange = specializedItems => {
    this.setState({specializedItems});
  ...
  componentDidMount() {
    ...
    mydata.once('value', dataSnap => {
      ...
      console.log(this.state.dataSource);
          ...
          myCustomShare = async (specializedItems) => {
             if(!specializedItems){
            ...
            try {
              const result = await Share.share({
                ...
                message: `Hey,  ${specializedItems}  would like you join flincs \n https://flincsapplicationv1.page.link/rniX`, 
  ...
  render() {
    ...
    const { dataSource,specializedItems } = this.state;
    ...
    return (
      ...
      <MultiSelect
        ...
        selectedItems={specializedItems}
        selectText=" Make your Flincs Group"
       ...
       // tagTextColor="#CCC"
        ...
        selectedItemTextColor="#359575"
        selectedItemIconColor="#359575"
        itemTextColor="#000"
        displayKey="contactName"
        // searchInputStyle={{ color: '#359575' }}
        submitButtonColor="#3399FF"
...
<TouchableOpacity onPress={()=>this.myCustomShare(specializedItems)} style={styles.menuStyle}>
